            ...
            <div class="col-10 col-sm-8 col-md-7 col-lg-4">
                <div class="card bg-dark">
                    <div class="card-body">
                        ...
                        <h3 class="card-title text-center mb-5 mt-4 text-white">Crea una cuenta en chatify</h3>
                        <form action="model/loginqueries.php" method="POST">
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="email" class="form-control" id="email" name="email" placeholder="correo@electrónico.com" required>
                            </div>
                            <?php
                            ...
                            <div class="text-center">
                                <button type="submit" name="register" class="btn btn-primary w-75 rounded-pill mt-4 mb-4">Entrar</button>        
                            </div>                 
                        </form>
                    </div>
                </div>
